//
//  LXJObjectFourTableViewController.m
//  LXJRecordLife
//
...
@interface LXJObjectFourTableViewController ()
@property (nonatomic, strong) NSArray *allQuestions;
@end

@implementation LXJObjectFourTableViewController
